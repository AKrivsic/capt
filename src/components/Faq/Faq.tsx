  ...
  },
  {
    ...
    answer: (
      <>
        ...
        Wanna taste? Jump into the{" "}
        <a
          href="#demo"
          onClick={() => {
            trackDemoClick("faq");
            trackGeneratorAccess("faq");
          }}
        >
          Demo
        </a>.
  ...
  },
  {
    ...
    answer: (
      <>
        ...
        or dive deeper in the{" "}
        <a
          href="#generator"
          onClick={() => trackGeneratorAccess("faq")}
        >
          Generator
        </a>.
      </>
  ...
  },
  {
    ...
    answer: (
      <>
        ...
        Want proof? Just give it a spin in the{" "}
        <a
          href="#generator"
          onClick={() => trackGeneratorAccess("faq")}
        >
  ...
  },
  {
    ...
    answer: (
      <>
        ...
        or wait until the clock resets ⏰.{" "}
...
export default function Faq() {
  ...
  const ids = useMemo(() => faqs.map((q) => `faq-${slugify(q.question)}`), []);
